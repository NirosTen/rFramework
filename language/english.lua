Locales['english'] = {
	...
	-- Version
	["startup"] = "^1Your version doesn't seem to be up to date. Please go to github.com/dev to download the newest version^2",
	...
	["startup5"] = "^2All working correcly, Framework started^2",
